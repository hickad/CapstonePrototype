...
<body>
    ...
    <h2 class="ui header">Mentor Comments</h2>    
    <hr>
    ...
    <!--This is the donor table and the add donor button.-->
      <div id="uxTableView">  
        ...
        <div id="uxAddDonorBtn" class="ui left small primary labeled icon button">
          <i class="user icon"></i> Add comment
        </div>
 ...
 // INITIAL CONDITION
 //  
var dt = [{numberItems:3,totalValue:"Keep up the good work.",date:"4/02/2016"},
		  {numberItems:1,totalValue:"Dont be late for the interview.",date:"2/12/2016"},
		  {numberItems:4,totalValue:"I will see you on Sunday.",date:"4/23/2016"},
		  {numberItems:1,totalValue:"I have a job opportunity for you.",date:"4/02/2016"},
		  {numberItems:2,totalValue:"What do you hope to get out of this program.",date:"3/30/2016"},
		  {numberItems:6,totalValue:"We should meet and talk about your future.",date:"1/23/2016"}];
